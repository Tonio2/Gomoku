...
const stoneStyle = (value: string, type: StoneType) => {
  const suffix = ["", " opacity-0 hover:opacity-50 duration-400", " opacity-50 text-red-500 text-center text-lg font-bold line-height-[30px]", ""][type]
  ...
  return style + (type != StoneType.Display ? position + animation : "" ) + suffix;
};
